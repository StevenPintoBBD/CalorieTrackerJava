import { ArraySchema, BooleanSchema, IntegerSchema, MapSchema, NumberSchema, ReferenceSchema, Schema, StringSchema } from '@hilla/generator-typescript-core/Schema.js';
...
export declare class ModelSchemaTypeProcessor extends ModelSchemaPartProcessor<TypeReferenceNode> {
    ...
    protected [$processNumber](schema: NumberSchema | IntegerSchema): TypeReferenceNode;
...
export declare class ModelSchemaExpressionProcessor extends ModelSchemaPartProcessor<readonly Expression[]> {
    ...
    protected [$processNumber](_: NumberSchema | IntegerSchema): readonly Expression[];
